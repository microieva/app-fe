    ...
    async loadJustCreatedAppointment(patientId: number){
        ...
        try {
            ...
            if (response.data.justCreatedAppointment) {
                ...
                this.eventStartTime = DateTime.fromISO(response.data.justCreatedAppointment.start).toFormat('HH:mm a');
                this.eventEndTime = DateTime.fromISO(response.data.justCreatedAppointment.end).toFormat('HH:mm a');
